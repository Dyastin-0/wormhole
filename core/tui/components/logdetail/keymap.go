...
func DefaultKeyMap() KeyMap {
	return KeyMap{
		...
		Focus:         key.NewBinding(key.WithKeys("f"), key.WithHelp("f", "switch focus")),
		...
		GotoTop:       key.NewBinding(key.WithKeys("shift+up", "K"), key.WithHelp("shift+↑/K", "top")),
		GotoTopAlt:    key.NewBinding(key.WithKeys("g"), key.WithHelp("gg", "top alt")),
		GotoBottom:    key.NewBinding(key.WithKeys("shift+down", "J"), key.WithHelp("shift+↓/J", "bottom")),
		GotoBottomAlt: key.NewBinding(key.WithKeys("G"), key.WithHelp("G", "bottom alt")),
...
func (k KeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.Help, k.Focus, k.Tab, k.GotoTopAlt, k.GotoBottomAlt},
	}
}
